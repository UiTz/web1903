  ...
  <div class="container">
    <div class="row m-0">
        ...
        <div class="col-md-6 col-sm-12 p-0 mt-5">
            ...
            <p>数量：
                <el-button type="light">1</el-button>
                <el-button class="icon1" type="light" icon="el-icon-arrow-up"></el-button>
                <el-button class="icon2" type="light" icon="el-icon-arrow-down"></el-button>
                <span>项</span>
                <span>剩余库存：</span>
                <span>9999项</span>
            </p>
