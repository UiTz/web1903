<template>
 ...
 <div>
    <div class="move" @mouseover="over()" @mouseout="out()" @mousemove="move($event)"> 
        <div id="small"> 
        <div id="float"></div>  
        <img src="../../public/img/productDetails/product-3.png" id="smallimg"></div>  
    </div>
      <div id="big"><img src="../../public/img/productDetails/product-3.png"></div>    
  </div>
            <div><img class="my-img1" src="../../public/img/productDetails/product-3.png" /></div>
            </div>
        <div class="col-md-6 col-sm-12 p-0 mt-5">
            <h5>芒果岩烧吐司</h5>
            <ul class="stars p-0">
